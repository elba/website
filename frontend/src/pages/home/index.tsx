...
const Hero: React.FunctionComponent = () => (
    <div className={style["hero"]}>
        <div className={style["hero-text"]}>
            <h1>Blazingly fast and modern{'\n'}
                package manager{'\n'}
                for{'\n'}
                <a className={style["highlight"]} href="#">Idris</a>
            </h1>
        </div>

        <div className={style["hero-buttons"]}>
            <div className={style["hero-button-container"]}>
                <a className={[style["hero-button"], "button", "is-purple", "has-shadow"].join(" ")}
                    href="#">Get Started</a>
            </div>
            <div className={style["hero-button-container"]}>
                <a className={[style["hero-button"], "button", "is-purple", "has-shadow"].join(" ")}
...
const Question: React.FunctionComponent = () => (
    <div className={[style["section"], style["question"]].join(" ")}>
        ...
        <a className={[style["question-button"], "button", "is-purple", "has-shadow"].join(" ")}
            href="#">Start to explore elba</a>
    </div>
)
